...
[![CI](https://github.com/ryan00x/MAP/actions/workflows/ci.yml/badge.svg)](https://github.com/ryan00x/MAP/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/ryan00x/MAP.git
cd MAP
cp .env.example .env
```
